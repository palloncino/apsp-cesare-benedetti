			...
			array(
				...
				'social'               => array(
					'enableSocial'           => array(
						...
						'default'   => 0,
						'priority'  => 10,
						'children'  => array( 'enableTwitter', 'enableFacebook', 'enableWhatsapp', 'enableLinkedin', 'enablePinterest', 'enableEmail', 'socialIconColor', 'socialIconSize', 'socialIconPadding', 'socialDesktopCollapsed' ),
						'data_type' => 'bool',
					),
					'enableTwitter'          => array(
					...
					'socialDesktopCollapsed' => array(
						'name'      => esc_html__( 'Desktop Collapsable', 'modula-best-grid-gallery' ),
						'type'      => 'toggle',
						'default'   => 1,
						'is_child'  => true,
						'priority'  => 60,
